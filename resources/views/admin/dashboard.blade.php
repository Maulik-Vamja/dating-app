                ...
                <div class="card card-custom rounded-xl gutter-b bg-dark card-stretch">
                    <div class="d-flex align-items-center mr-2">
                        <div class="symbol-label px-6 py-8 rounded-xl mr-7">
                            ...
                            <span class="font-size-h6 text-muted font-weight-bold">Total Users</span>
                        </div>
                        <div>
                            <div class="font-size-h1 text-white font-weight-bolder">{{ $user['Count'] ?? 0 }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-custom rounded-xl gutter-b bg-dark card-stretch">
                    <div class="d-flex align-items-center mr-2">
                        <div class="symbol-label px-6 py-8 rounded-xl mr-7">
                            ...
                            <span class="font-size-h6 text-muted font-weight-bold">Per Day</span>
                        </div>
                        <div>
                            <div class="font-size-h1 text-white font-weight-bolder">{{ $user['PerDayCount'] ?? 0 }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-custom rounded-xl gutter-b bg-dark card-stretch">
                    <div class="d-flex align-items-center mr-2">
                        <div class="symbol-label px-6 py-8 rounded-xl mr-7">
                            ...
                            <span class="font-size-h6 text-muted font-weight-bold">Per Week</span>
                        </div>
                        <div>
                            <div class="font-size-h1 text-white font-weight-bolder">{{ $user['PerWeekCount'] ?? 0 }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-custom rounded-xl gutter-b bg-dark card-stretch">
                    <div class="d-flex align-items-center mr-2">
                        <div class="symbol-label px-6 py-8 rounded-xl mr-7">
                            ...
                            <span class="font-size-h6 text-muted font-weight-bold">Per 30 Day</span>
                        </div>
                        <div>
                            <div class="font-size-h1 text-white font-weight-bolder">{{ $user['Per30DayCount'] ?? 0 }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 py-5">
                        <div class="card-title">
                            <h3 class="card-label">User Errors</h3>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0">
                        <div class="row pt-0">
                            <div class="col-sm-12">
                                <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline" id="error_DT"></table>
                            </div>
                        </div>
                    </div>
                </div>

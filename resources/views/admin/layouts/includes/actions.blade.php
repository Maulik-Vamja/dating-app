...
<a href="{{ route($routeName . '.show', $id) }}" onclick="addOverlay()"
    class="btn btn-icon btn-light btn-hover-info btn-sm" title="View {{ $custom_title ?? '' }}">
...
<a href="{{ route($routeName . '.edit', $id) }}" onclick="addOverlay()"
    class="btn btn-icon btn-light btn-hover-warning btn-sm mx-3" title="Edit {{ $custom_title ?? '' }}">
...
<button data-target-href="{{ route($routeName . '.destroy', $id) }}"
    class="btn btn-icon btn-light btn-hover-danger btn-sm action-delete" title="Delete {{ $custom_title ?? '' }}">

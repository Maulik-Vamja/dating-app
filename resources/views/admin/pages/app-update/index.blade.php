                ...
                <div class="card-body">
                    ...
                    @foreach ($settings as $setting)
                        ...
                        <div class="form-group">
                            <label for="build_version[{{ $setting->slug }}]">{!! $mend_sign !!}
                                {{ ucfirst($setting->slug) }} Build
                                Version :</label>
                        ...
                        {{-- app_version --}}
                        <div class="form-group">
                            <label for="app_version">{!! $mend_sign !!} {{ ucfirst($setting->slug) }} App
                                Version:</label>
                    ...
                    @endif --}}
                            ...
                            <label class="checkbox">
                                <input type="checkbox" name="is_force_update[{{ $setting->slug }}]"
                                    @if ($setting->is_force_update == 1) checked="checked" @endif />
                                <span></span>

                    ...
                    <div class="card-body pt-15">
                        <div class="text-center mb-10">
                            <div class="symbol symbol-60 symbol-circle symbol-xl-90">
                                <div class="symbol-label" style="background-image:url({{ generate_url($admin->profile_photo) }})"></div>
                        ...
                        <ul class="nav nav-tabs flex-column">
                            <li>
                                <a href="#personal_info" data-toggle="tab" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 text-center btn-block active">Personal info</a>
                            </li>
                            <li>
                                <a href="#change_password" data-toggle="tab" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 text-center btn-block">Change Password</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <form class="form" id="profile_update_form" action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label text-right">Avatar {{ $admin->first_name }}</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{ generate_url($admin->profile_photo)}})">
                                                    <div class="image-input-wrapper" style="background-image:url({{ generate_url($admin->profile_photo)}})"></div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control form-control-lg" name="first_name" id="first_name" type="text" value="{{ $admin->first_name }}" placeholder="Enter name" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input type="text" class="form-control form-control-lg" name="contact_number" id="contact_number" value="{{ $admin->contact_number}}" placeholder="Contact Number" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input type="text" class="form-control form-control-lg" name="email" id="email" value="{{ $admin->email }}" placeholder="Email" />
                                                @if ($errors->has('email'))
                                                    <span class="text-danger">

                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                            <label for="first_name" class="control-label">First Name:{!! $mend_sign !!}</label>
                        ...
                        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                            <label for="last_name" class="control-label">Last Name:{!! $mend_sign !!}</label>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="control-label">Email:{!! $mend_sign !!}</label>
                            <input type="email" name="email" readonly="readonly" class="form-control"
                                placeholder="Enter your Email" value="{{ $role->email ?? '' }}">
                            @if ($errors->has('email'))
                                <span class="invalid-feedback">
                        ...
                        <div class="form-group{{ $errors->has('contact_number') ? ' has-error' : '' }}">
                            <label for="contact_number">Contact No:{!! $mend_sign !!}</label>
                            <input type="text" name="contact_number" class="form-control"
                                placeholder="Enter your Contact" value="{{ $role->contact_number ?? '' }}">
                        ...
                        <div class="table-responsive form-group{{ $errors->has('roles') ? ' has-error' : '' }}">
                            <label class="col-md-8 col-md-offset-4"
                                ...
                                permission!</label>
                            <label for="roles" class="col-md-4">User Permissions:</label>
                                            ...
                                            <tr class="role_row_{{ $roleId }}">
                                                ...
                                                <td>
                                                    @if (in_array('access', $allowed_permissions))
                                                        <input
                                                            class="premision_check access_{{ $roleId }} role_{{ $roleId }}"
                                                            data-id="{{ $roleId }}"
                                                            data-error-container='#permission_error'
                                                            name="roles[{{ strtolower($user_role->id) }}][permissions][]"
                                                            type="checkbox" value="access"
                                                            {{ in_array('access', $permissions) ? 'checked' : '' }}
                                                            {{ $roleId == 1 ? 'checked disabled' : '' }}>
                                                        @if ($user_role->id == 1)
                                                            <input type="hidden"
                                                                name="roles[{{ strtolower($user_role->id) }}][permissions][]"
                                                                value="access">
                                                ...
                                                <td>
                                                    @if (in_array('add', $allowed_permissions))
                                                        <input class="premision_check role_{{ $roleId }}"
                                                            data-id="{{ $roleId }}"
                                                            data-error-container='#permission_error'
                                                            name="roles[{{ strtolower($user_role->id) }}][permissions][]"
                                                            type="checkbox" value="add"
                                                            {{ in_array('add', $permissions) ? 'checked' : '' }}>
                                                        @php $total_count++ @endphp
                                                    @else
                                                        N / A
                                                    @endif
                                                ...
                                                <td>
                                                    @if (in_array('edit', $allowed_permissions))
                                                        <input class="premision_check role_{{ $roleId }}"
                                                            ...
                                                            {{ in_array('edit', $permissions) ? 'checked' : '' }}>
                                                        @php $total_count++ @endphp
                                                    @else
                                                        N / A
                                                    @endif
                                                ...
                                                <td><input type="checkbox"
                                                        class="checkrow all_rolechecked_{{ $roleId }}"
                                                        name="checkrow" data-roleid='{{ $roleId }}'></td>
                                            </tr>
                                        @endif
                                        @php $roleId++ @endphp
                                    @endforeach

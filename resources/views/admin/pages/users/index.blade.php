...
@push('extra-js')
    ...
    <script>
        ...
        oTable = table.dataTable({
            ...
            ajax: {
                "url": "{{ route('admin.users.index') }}", // ajax source
            },
            language: {
            ...
            "columns": [
                ...
                @endif
                { data: "first_name", title: "First Name", sortable: true },
                { data: "last_name", title: "Last Name", sortable: true },
                { data: "email", title: "Email", sortable: true },
                { data: "contact_number", title: "Contact No", sortable: true, searchble: false },
